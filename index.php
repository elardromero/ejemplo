...
/*PROCESS*/
	...
	$app_id = '1099967786684704';
	$app_secret = '657c0aeb7b7d4b79ae9e728e1ce25fc5';
	$redirect_url='http://localhost/elard/fblogin2/';
	...
	$login_url = $helper->getLoginUrl(array('email','publish_actions','user_likes','user_friends'));
	//logout
	$logout = 'http://localhost/elard/fblogin2/index.php?logout=true';
